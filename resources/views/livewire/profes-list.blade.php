<div class="flex flex-col items-center justify-start gap-3">
    <div class="w-full p-2 bg-amber-500 ">
        <div class="w-full px-5 text-4xl font-bold mb-4 md:text-center">
            Bienvenido a la Profedex
        </div>
            ...
            <div class="w-2/5 h-full overflow-hidden bg-amber-500 border-4 flex items-center gap-5"
                ...
                <div
                    ...
                    <div class="flex flex-col justify-center items-center w-full gap-1">
                        ...
                        <div
                            class="flex flex-col gap-1 justify-center items-center bg-white px-3 py-2  w-full">
                    ...
                    <div
                        class="flex gap-2 justify-center items-center bg-purple-700 text-xs px-2 py-2  w-full">
                ...
                <div class="w-1/2 h-full flex flex-col justify-start items-center gap-3 overflow-y-auto p-2">
                    ...
                    <div class="flex flex-col justify-center items-center w-full">
                        <div class="flex flex-col gap-1 justify-center items-center bg-sky-500 px-3 py-2 w-full">
                            ...
                            <div class="flex flex-wrap justify-center items-center w-full gap-1">
                                @if ($items->isEmpty())
                                    <p>No tiene items.</p>
                                @else
