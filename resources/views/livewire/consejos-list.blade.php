<div class="flex flex-col items-center justify-start gap-3 mb-5">
    ...
    <div class="w-full flex flex-wrap justify-center md:items-stretch items-center gap-10 mt-10">
        @if ($showNoResults)
    ...
    @if ($selectedConsejo)
        <div class="fixed w-full h-full inset-0 bg-black/50 z-50 flex justify-center items-center">
            <div class="w-2/3">
                    ...
                    <div class="w-11/12 flex flex-col p-2 gap-1 overflow-hidden">
                        <div class="w-full flex justify-center items-center">
                            <div class="w-full flex flex-col shrink-0">
                                ...
                                <span class="text-base font-semibold flex w-full text-sky-800 break-words">{{ $consejo->semestre }}
                        ...
                        <div class="w-ful flex gap-5 p-2">
                            <div class="flex gap-2 justify-center items-center">
                                ...
                                <div class="underline text-amber-600 font-extrabold">{{ $selectedConsejo->user->username }}</div>
                            </div>
                            <div
