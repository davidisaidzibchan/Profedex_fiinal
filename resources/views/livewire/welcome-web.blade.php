            ...
            <div class="flex flex-col w-full p-3 justify-center">
                <div class="w-full overflow-hidden flex flex-col items-center justify-center gap-4">
                    ...
                    <p class="lg:text-lg text-sm text-center">
                        Bienvenido a la profedex: un espacio  único y divertido que fusiona la esencia de JoJo's Bizarre Adventure con tus profes del tec de motul. 
                        En estas páginas, descubrirás a tus maestros de isc  transformados en héroes extraordinarios, cada uno con su propio Stand y habilidades asombrosas.
                    </p>
                </div>
            </div>
            <div class="flex flex-col w-full p-3 justify-center">
            ...
            <div class="flex flex-col w-full p-3 justify-center">
                <div class="w-full overflow-hidden flex flex-col items-center justify-center gap-4">
                    ...
                    <div class=" w-52 bg-neutral-200 overflow-hidden">
                        <img src="/img/17_Card_MatrixMaven_Final.png" alt="profe" class="bg-cover object-top w-full h-full">
                    </div>
                </div>
            </div>
            <div class="flex flex-col w-full p-3 justify-center">
