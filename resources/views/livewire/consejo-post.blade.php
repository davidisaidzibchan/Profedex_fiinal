<div class="flex flex-col items-center justify-start gap-3 mb-5 ">
    <div class="w-full p-2 bg-amber-500 ">
        <div class="w-full px-5 mb-4 md:text-center">
            <div class="text-base font-semibold">Lorem ipsum dolor sit amet.</div>
            <div class="text-sm">Consectetur adipiscing elit. Proin vel nisl sit amet leo sollicitudin euismod eu non
                leo.</div>
        </div>
    </div>
