        ...
        <div class="w-full md:flex hidden">
            <div class="w-1/2 shrink-0 flex flex-col items-center p-5">
                <div>
                    ...
                    <div class="text-white text-xl font-bold">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    </div>
                    <div class="text-white text-xl">
                        <ul class="list-disc italic">
                            <li>Nullam eget libero nec quam porttitor mollis.
                            </li>
                            <li>Nam eu vulputate sapien. </li>
                        </ul>
                    </div>
                </div>
            </div>
